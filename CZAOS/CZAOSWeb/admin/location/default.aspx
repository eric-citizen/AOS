...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <a class="add-link ui-dialog-link" href="/admin/location/edit-location.aspx" data-args="300, 700, true, null, 1" title="Add New Location">Add New Location</a>
    <a class="add-link ui-dialog-link" href="/admin/location/sort-location.aspx" data-args="720, 700, true, null, 1" title="Edit Sort Order">Edit Sort Order</a>
    ...
    <asp:GridView ID="gvLocation" runat="server" DataSourceID="cztDataSource" AllowSorting="True" AllowPaging="True" CssClass="gridview"
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:HyperLink runat="server" ID="lnkEdit" CssClass="ui-dialog-link gv-edit-link" data-args="300, 700, true, null, 1" Text="Edit" ToolTip="Edit Location" NavigateUrl='<%# Bind("LocationID","~/admin/location/edit-location.aspx?locId={0}") %>'></asp:HyperLink>
                </ItemTemplate> 
