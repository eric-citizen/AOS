...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">    
    ...
    <asp:GridView ID="gvLog" runat="server" DataSourceID="cztDataSource" AllowSorting="True" AllowPaging="True" CssClass="gridview"
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:HyperLink runat="server" ID="lnkView" CssClass="ui-dialog-link view" data-args="600, 700, true, null, 0" Text="" ToolTip="View Changes" NavigateUrl='<%# Bind("ID","~/admin/changes/view-changes.aspx?id={0}") %>'></asp:HyperLink>
                </ItemTemplate> 
    ...
    <uc1:GridPager runat="server" ID="gvPagerControl" GridViewID="gvLog" HideOnEmpty="False"/>
