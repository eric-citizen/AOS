<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/Dialog.Master" AutoEventWireup="true" CodeBehind="edit-weather.aspx.cs" Inherits="CZAOSWeb.admin.weather.edit_weather" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <fieldset class="form-fieldset">
        ...
        <legend>
            <asp:Literal runat="server" ID="fieldsetLegend">Edit Weather Condition</asp:Literal>
        </legend>   
