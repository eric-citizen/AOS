...
namespace CZAOSWeb.admin.weather
{
    public partial class _default : MainBase
    {
        ...
        protected void cztDataSource_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
        {
            ...
            {
                e.InputParameters["filterExpression"] = "Weather LIKE '" + AlphabetFilter.Filter + "%'";
            }
            else
            {
        ...
        protected void IsActiveCheckChanged(object sender, EventArgs e)
        {
            ...
            WeatherCondition item = WeatherConditionList.GetItem(id);
        ...
        {
            if (e.CommandName == "DeleteWeather" && base.IsMasterAdmin)
            {
