<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/Dialog.Master" AutoEventWireup="true" CodeBehind="sort-behavior.aspx.cs" Inherits="CZAOSWeb.admin.dialogs.sort_behavior" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function UpdateSortOrder(sortedIds) {
            ...
            var API_URL = "sort-behavior.aspx/SaveSortOrder";
            var bcatId = $("#hdnCategoryID").val();
            ...
            $.ajax({
                ...
                data: "{'bcatId' :'" + bcatId + "','sortedIds' : '" + sortedIds + "'}",
                statusCode: {
                    500: function (data) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <mack:HiddenID runat="server" ID="hdnCategoryID" ClientIDMode="Static" />

    <fieldset class="form-fieldset">
        
        <legend>
            <asp:Literal runat="server" ID="fieldsetLegend">Edit Behaviors Sort Order</asp:Literal>
        </legend>   
            ...
            <asp:Repeater runat="server" ID="rptSortItems" OnItemDataBound="rptSortItems_ItemDataBound">
                <ItemTemplate>
                    <li runat="server" id="liSortItem" class="ui-state-default">
                        ...
                        <asp:Literal runat="server" ID="litName" Text='<%# Bind("BehaviorName") %>'></asp:Literal>
                    </li>
                </ItemTemplate>
            </asp:Repeater>         
