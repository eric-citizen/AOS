...
{
    public partial class sort_behavior_category : MainBase 
    {
        ...
        {
            rptSortItems.DataSource = BehaviorCategoryList.GetItemCollection(0, 0, "SortOrder ASC", "");
        ...
        public static void SaveSortOrder(string sortedIds)
        {
            ...
            if (newOrder.Count > 0)
            {
                BehaviorCategoryList items = BehaviorCategoryList.GetItemCollection(0, 0, "SortOrder ASC", "");
                ...
                BehaviorCategoryList.UpdateSort(sortList);
