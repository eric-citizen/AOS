<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/Dialog.Master" AutoEventWireup="true" CodeBehind="sort-behavior-category.aspx.cs" Inherits="CZAOSWeb.admin.dialogs.sort_behavior_category" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function UpdateSortOrder(sortedIds) {
            ...
            var API_URL = "sort-behavior-category.aspx/SaveSortOrder";
            //var bcatId = $("#hdnID").val();
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <fieldset class="form-fieldset">
        ...
        <legend>
            <asp:Literal runat="server" ID="fieldsetLegend">Edit Behavior Category Sort Order</asp:Literal>
        </legend>   
            ...
            <asp:Repeater runat="server" ID="rptSortItems" OnItemDataBound="rptSortItems_ItemDataBound">
                <ItemTemplate>
                    <li runat="server" id="liSortItem" class="ui-state-default">
                        ...
                        <asp:Literal runat="server" ID="litName" Text='<%# Bind("BvrCat") %>'></asp:Literal>
                    </li>
                </ItemTemplate>
            </asp:Repeater>         
